  ...
  return (
    <section>
      <div className="pt-5 lg:pt-10 lg:w-1/2 lg:pl-16">
        ...
        <a href="">
          <div className="bg-sky-500 rounded-lg lg:rounded-full w-1/2 mx-auto lg:mx-0 lg:ml-6 p-2 lg:p-4 mt-10 text-center text-white font-bold text-xl lg:text-2xl">
            Hubungi Saya
          </div>
        </a>
      </div>
